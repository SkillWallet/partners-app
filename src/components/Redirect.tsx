...
import skillWalletAbi from '@partners-api/abi/SkillWallet.json';
...
const Redirect = () => {
  ...
  const addDiscordIDToSkillWallet = async (discordId) => {
    ...
    const contract = new ethers.Contract(skillWalletAddress, JSON.stringify(skillWalletAbi), signer);
