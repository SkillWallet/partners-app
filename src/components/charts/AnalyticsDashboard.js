...
import roleActivity from '@partners-assets/role-activity.svg';
import checkups from '@partners-assets/checkups-dark.svg';
import listedContracts from '@partners-assets/listed-contracts.svg';
import addContract from '@partners-assets/add-contract.svg';
import logOff from '@partners-assets/log-off.svg';
import overviewStatsWhite from '@partners-assets/overview-stats-white.svg';
import logo from '@partners-assets/sw-logo.svg';
import geometricLine from '@partners-assets/geometric-card-line-break.png';
import dPad from '@partners-assets/d-pad-logo.png';
import blueChartStroke from '@partners-assets/blue-chart-stroke.svg';
import blackChartStroke from '@partners-assets/black-chart-stroke.svg';
import dots from '@partners-assets/dots-icon.svg';
